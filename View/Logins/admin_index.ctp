<div class="logins index">
	...
	<tr>
		...
		<td><?php echo h($login['Login']['email']); ?>&nbsp;</td>
		<td><?php echo h($login['Login']['password']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $login['Login']['id']), null, __('Are you sure you want to delete # %s?', $login['Login']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
